...
const menuItems = [
  ...
  { Image: '/images/ch9.jpg', price: '$120', title: 'Cashew Chicken', rating: 5 },
  ...
  { Image: '/images/pf7.png', price: '$180.23', title: 'Chicken Biryani', rating: 4.5 },
  { Image: '/images/pf10.jpg', price: '$95.12', title: 'Fish Fry', rating: 5 },
        ...
        {menuItems.map((item) => (
          <div key={item.title} className='bg-red-800/55 p-5 rounded-lg shadow-lg transition-transform transform hover:scale-95 hover:shadow-2xl duration-300 h-auto w-64'>
            <div className="relative h-56 w-full">
              <Image src={item.Image} alt={item.title} width={150} height={150}  className="rounded-t-lg h-full w-full object-cover" />
            </div>
