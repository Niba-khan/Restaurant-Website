        ...
        <div className="pt-20 pb-12">
            ...
            <div className="mt-20 w-4/5 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                ...
                <div className="bg-white/45 shadow-md rounded-md p-5 text-center border-4 border-black/60">
                    <img src="/images/team1.jfif" alt="Chef Mahboob Khan" className="mx-auto border-4 border-red-700 rounded-md" />
                ...
                {/* Chef Card 2 */}
                <div className="bg-white/45 shadow-md rounded-md p-5 text-center border-4 border-black/60">
                    <img src="/images/team2.jpg" alt="Chef Samia Adil" className="mx-auto border-4 border-red-700 rounded-md" />
                ...
                {/* Chef Card 3 */}
                <div className="bg-white/45 shadow-md rounded-md p-5 text-center border-4 border-black/60">
                    <img src="/images/team3.jfif" alt="Chef Zakir" className="mx-auto border-4 border-red-700 rounded-md" />
